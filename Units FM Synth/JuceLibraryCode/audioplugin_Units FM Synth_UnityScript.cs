...
public class audioplugin_Units_FM_SynthGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_Units FM Synth"; } }
    public override string Description    { get { return "Units FM Synth"; } }
    public override string Vendor         { get { return "Sinecure Audio"; } }

    //==============================================================================
	[DllImport("audioplugin_Units FM Synth")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_Units FM Synth")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_Units FM Synth")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Units FM Synth")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Units FM Synth")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_Units FM Synth")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_Units FM Synth")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
